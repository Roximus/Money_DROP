...
// Obtenez les éléments audio
var waitingAudio = document.getElementById("../static/audio/attente");
var correctAudio = document.getElementById("../static/audio/bonne réponse");
var wrongAudio = document.getElementById("../static/audio/mauvaise réponse");

var duration = { game_session.duration }; // Durée du jeu en secondes
var timerDisplay = document.getElementById("timer");


// Appeler la fonction lorsque le contenu de la page est chargé
document.addEventListener("DOMContentLoaded", function() {
    startTimer();
    playWaitingAudio();
});
